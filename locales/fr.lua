...
local locale = {
    ...
    users_placeholder_password = "mot de passe",
    ...
    partials_placeholder_search = "Rechercher",
    ...
    index_alt_snap = "Snap!",
    layout_placeholder_search = "Rechercher",
    ...
    partials_placeholder_username = "nom d'utilisateur",
