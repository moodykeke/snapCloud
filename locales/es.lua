...
local locale = {
    ...
    users_placeholder_password = "contraseña",
    ...
    partials_placeholder_search = "Buscar",
    ...
    index_alt_snap = "Snap!",
    layout_placeholder_search = "Buscar",
    ...
    partials_placeholder_username = "nombre de usuario",
