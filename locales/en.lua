...
Want to know more? Visit @2]],
    ...
    partials_placeholder_search = "Search",
    ...
    index_alt_snap = "Snap!",
    layout_placeholder_search = "Search",
    ...
    partials_placeholder_username = "username",
    ...
    view_user_projects = "View user's projects",
    view_user_page = "Go to user page",
    ...
    view_shared_projects = "View shared projects",
    view_published_projects = "View published projects",
    more = "more",
